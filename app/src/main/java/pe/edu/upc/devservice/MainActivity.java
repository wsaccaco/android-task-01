...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceRecyclerView = (RecyclerView) findViewById(R.id.serviceRecyclerView);
        serviceRecyclerView.setLayoutManager(itemLayoutManager);
        serviceRecyclerView.setAdapter(itemAdapter);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            ...
            fragmentmanager.beginTransaction()
                    .replace(R.id.content_frame, new ServiceFragment())
                    .commit();
        }
